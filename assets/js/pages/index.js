...
const T = {
  fr: {
    ...
    'offre.cta.quote': 'Réserver ma consultation',
    ...
    'hiw.lbl': 'Comment ça marche', 'hiw.h2': 'Vos livraisons, <span class="ac">entre de bonnes mains.</span>',
    ...
    'recruit.p': 'Emploi salarié, horaires flexibles, matériel fourni, assurance complète. Un vrai job, pas une mission freelance.',
    'recruit.b1': 'Salarié(e)', 'recruit.b2': 'Horaires flex', 'recruit.b3': 'Assuré', 'recruit.b4': 'Matériel fourni',
    ...
    'faq.sd': 'Pas trouvé ? <a href="#booking" style="color:var(--teal);font-weight:700">Réservez une consultation</a>.',
    ...
    'float.cta': 'Réserver ma consultation',
  },
  en: {
    ...
    'offre.cta.quote': 'Book my consultation',
    ...
    'hiw.lbl': 'How it works', 'hiw.h2': 'Your deliveries, <span class="ac">in good hands.</span>',
    ...
    'vpc3.h3': 'Swiss reliability', 'vpc3.p': '800 employed couriers (not freelancers), in-house training, full insurance and proof of delivery on every order.', 'vpc3.big': '100% employed',
    ...
    'faq.sd': 'Can\'t find it? <a href="#booking" style="color:var(--teal);font-weight:700">Book a consultation</a>.',
