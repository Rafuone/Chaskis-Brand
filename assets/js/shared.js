...
(function renderChrome() {
  ...
  if (menuEl) {
    ...
    const extraLinks = extra
      ? `
    <a href="index.html#booking" onclick="cm()">Réserver une consultation</a>
...
window.T_BASE = window.T_BASE || {
  fr: {
    ...
    'foot.svc.h': 'Services', 'foot.svc.1': 'Commander', 'foot.svc.2': 'Tableau de bord', 'foot.svc.3': 'Nos secteurs', 'foot.svc.4': 'Réserver une consultation',
  ...
  en: {
    ...
    'foot.svc.h': 'Services', 'foot.svc.1': 'Order', 'foot.svc.2': 'Dashboard', 'foot.svc.3': 'Our sectors', 'foot.svc.4': 'Book a consultation',
...
window.__chaskisUpdateLangUI = function(lang) {
  ...
  if (triggerFlag) {
    const flagSrc = lang === 'en' ? 'assets/img/flag-gb.svg' : 'assets/img/flag-fr.svg';
...
// ===== CHATBOT WIDGET (auto-load on every page) =====
// v1 : chatbot DÉSACTIVÉ (décision produit). Pour le réactiver en v2, repasser CHATBOT_ENABLED à true.
